...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">我上傳的資料</li>
    </ol>
    <form action="/admin/guide_my" method="GET">
        <div class="row">
            <div class="col-xs-10">
                <div class="input-group input-group-sm">
                    ...
                    <span class="input-group-btn">
                        ...
                        <a href="/admin/guide_my" class="btn btn-default">清除</a>
                    </span>
                </div>
            </div>
            <div class="col-xs-2">
                <a href="#add" class="btn btn-default btn-sm btn-block">新增宣導資料</a>
            </div>
        </div>
    </form>
    @if ($guides->count() !== 0)
